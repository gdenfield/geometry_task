  ...
  <script>
    ...
    var instructions = {
      ...
      pages: [
        ...
        `<p>There are four pictures, each with its own correct direction. For example when you see:</p>
    ...
    var instructions6 = {
      type: 'instructions',
      pages: [
        `<p>You've got it!</p><p>The first picture had no colored square, but the last colored square you saw was red, so the correct direction for the garden picture was <b>right</b>.</p><p>The second picture was followed by another red square, so the correct direction did not change: <b>right</b> again!</p><p>Finally, the colored square changed back to blue, so the correct direction changed back to <b>up</b>.</p>`,
        ...
        `<b>Summary</b><br><img src='instruction_screen.png'/>`,
