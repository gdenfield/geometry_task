...
function [task_file] = append_block(task_file, n_repeats, cc, n_contextual_cues, fractals_in, held_out)
    ...
    response(stimuli==5 & context==2) = 2;
    response(stimuli==6 & context==2) = 3;
    response(stimuli==7 & context==2) = 4;
    response(stimuli==8 & context==2) = 1;
    ...
    reward(stimuli==5 & context==2) = 0;
    reward(stimuli==6 & context==2) = 1;
    reward(stimuli==7 & context==2) = 1;
    reward(stimuli==8 & context==2) = 0;
    ...
    % sc_on
    n_sc_trials = 0;
    sc_on = [zeros(block_length-n_sc_trials,1); ones(n_sc_trials,1)];
