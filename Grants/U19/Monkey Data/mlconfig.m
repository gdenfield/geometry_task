classdef mlconfig  % ConstructOnLoad is not necessary since the new definition will be enforced by loadobj()
    ...
    methods
        ...
        function obj = mlconfig()
            ...
            obj.EyeTracker = struct('Name','None','ID','','ViewPoint',struct,'EyeLink',struct,'ISCAN',struct,'Ver',1);
            ...
            obj.EyeTracker.ISCAN.IP_address = '169.254.200.231';
        ...
        function export_to_file(obj,fout,varname)
            ...
            try
                dest = [];
                field = [mlsetdiff(properties(obj),obj.TransientFields); 'MLVersion'; 'MLPath'];
