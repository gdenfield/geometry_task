...
def api_login(url, username, password):
	...
	r = requests.post(url+'/api/login', data = {'username': username, 'password': password}, verify=False)
...
## i.e. in browser, https:\\129.236.162.243:4343
# remote_url = '129.236.160.244'
remote_url = '129.236.163.248' # george camera computer IP
watchtowerurl = f'https://{remote_url}:4343'  
master_cameraname = 'e3v8229'
username = 'denfield'
password = 'emygdala'

# set global save path on host computer
save_root = 'C:\\Users\\Denfield\\Documents\\behavior_video'
# save_root = 'C:\\Users\\rober\\Desktop\\rhAirpuff\\videos\\george'
