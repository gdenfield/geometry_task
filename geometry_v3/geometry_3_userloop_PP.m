...
function [C,timingfile,userdefined_trialholder] = geometry_3_userloop_PP(MLConfig,TrialRecord)
% Training Variables
...
% Initialization
C = [];
timingfile = 'geometry_3_timingfile_PP.m';
...
image_list = {'stim_A.bmp','stim_B.bmp','stim_C.bmp', TrialRecord.User.ccOneName, TrialRecord.User.ccTwoName, TrialRecord.User.ccThreeName};
