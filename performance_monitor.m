function performance_monitor(TrialRecord)
    ...
    scatter(trial_number(trials==5&CC_trials==0),trials(trials==5&CC_trials==0),'filled','s','r')
    scatter(trial_number(trials==5&CC_trials==1),trials(trials==5&CC_trials==1),'s','r')

    scatter(trial_number(trials==6&CC_trials==0),trials(trials==6&CC_trials==0),'filled','d','r')
    scatter(trial_number(trials==6&CC_trials==1),trials(trials==6&CC_trials==1),'d','r')

    scatter(trial_number(trials==7&CC_trials==0),trials(trials==7&CC_trials==0),'filled','^','r')
    scatter(trial_number(trials==7&CC_trials==1),trials(trials==7&CC_trials==1),'^','r')

    scatter(trial_number(trials==8&CC_trials==0),trials(trials==8&CC_trials==0),'filled','s','m')
    scatter(trial_number(trials==8&CC_trials==1),trials(trials==8&CC_trials==1),'s','m')

    scatter(trial_number(trials==9&CC_trials==0),trials(trials==9&CC_trials==0),'filled','m')
    scatter(trial_number(trials==9&CC_trials==1),trials(trials==9&CC_trials==1),'o','m')
