...
% Initialization
C = [];
timingfile = 'geometry_2_timingfile_PP.m';
...
if isempty(TrialRecord.TrialErrors)
    ...
    TrialRecord.User.ccOneName = 'cc_1_PP.png';
    TrialRecord.User.ccTwoName = 'cc_2_PP.png';
...
% Switch Procedure
threshold = 0.66; % Hit rate
window = 9; % trials
blockThreshold = 0.60; % blockwise performance threshold for CC switch
...
if ((TrialRecord.CurrentTrialWithinBlock >= TrialRecord.User.block_length && criterion) || TrialRecord.User.switch == 1 ) && TrialRecord.TrialErrors(end)==0
    ...
    if switch_test
        ...
        if (TrialRecord.CurrentBlockCount - (TrialRecord.User.ChangeTriggeredAtBlock(end)-1)) >= nBlockTrigger ...
            ...
            d = 'C:\Users\silvia_ML\Documents\geometry_task\diag_CC_PP\';
            f = dir([d '*.png']);
            n = numel(f);
            idx = randperm(n, 2);
            ...
            copyfile([d TrialRecord.User.ccOneName], 'C:\Users\silvia_ML\Documents\geometry_task\geometry_v2\cc_1_PP.png','f')
            copyfile([d TrialRecord.User.ccTwoName], 'C:\Users\silvia_ML\Documents\geometry_task\geometry_v2\cc_2_PP.png','f')
            
            movefile([d TrialRecord.User.ccOneName], 'C:\Users\silvia_ML\Documents\geometry_task\used_diag_CC_PP','f')
            movefile([d TrialRecord.User.ccTwoName], 'C:\Users\silvia_ML\Documents\geometry_task\used_diag_CC_PP','f')
...
% Stimuli
image_list = {'stim_21.bmp','stim_81.bmp','stim_82.bmp', 'stim_95.bmp', 'stim_1539v4.bmp', 'stim_0016v2.bmp', 'stim_0233v3.bmp','stim_0042v2.bmp', 'cc_1_PP.png', 'cc_2_PP.png'};
