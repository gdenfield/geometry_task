...
no_cc_max = 40; % trial number within block after which CC is always shown
...
% Test for CC Trial
TrialRecord.User.CC = TrialRecord.CurrentTrialWithinBlock <= n_cc_trials || TrialRecord.CurrentTrialWithinBlock > no_cc_max || TrialRecord.User.SC;

%Build Scene    
if TrialRecord.User.CC || z < 92.5
