...
%% REWARDS
trial_correct = (ismember(TrialRecord.CurrentCondition, [1 4 8 12 15 17]) && mul6.ChosenTarget == up) || (ismember(TrialRecord.CurrentCondition, [2 5 9 10 13 18]) && mul6.ChosenTarget == right) || (ismember(TrialRecord.CurrentCondition, [3 6 7 11 14 16]) && mul6.ChosenTarget == left);
small_reward_trial = ismember(TrialRecord.CurrentCondition,[4 5 6 9 11 12 16 17 18]); % Test for large/ small trial; gd 3/30/22
