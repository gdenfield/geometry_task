classdef mlscreen < handle
    ...
    properties (SetAccess = protected)
        ...
        SubjectScreenHalfSize = [1024 768]/2
        DPI_ratio = 1
        PixelsPerDegree = 72
        RefreshRate = 60
        FrameLength = 1000/60
    ...
    methods
        ...
        function destroy(obj), if obj.ScreenCreated, mgldestroysubjectscreen; obj.ScreenCreated = false; end, end
        ...
        function create(obj,MLConfig)
            ...
            obj.VBlankLength = info.VBlankLength * 1000;
        ...
        function create_tracers(obj,MLConfig)
            ...
            obj.TouchCursor = NaN(1,max(2,MLConfig.Touchscreen.NumTouch));  % 2 cursors for simulation
            for m=1:length(obj.TouchCursor)
                obj.TouchCursor(m) = load_cursor(MLConfig.TouchCursorImage,MLConfig.TouchCursorShape,MLConfig.TouchCursorColor,MLConfig.TouchCursorSize,10);
            end
        ...
        function reposition_tracer(obj,DAQ)
